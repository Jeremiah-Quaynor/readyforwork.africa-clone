...
import banner from "../public/images/rfw-footer-logo.png"
...
const Footer = () => {
  ...
  return (
    <footer className="bg-black  border-t-2  ">
      <div className="max-w-screen-xl font-['inter'] px-4 py-16 mx-auto sm:px-6 ">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
              <Link href="/" className="flex">
                <span className="self-center text-lg font-semibold whitespace-nowrap dark:text-black">
                  <div className="relative w-24 h-24 sm:h-24  lg:h-24">
                      <Image src={banner} alt="Banner" className="w-[100%] h-[100%]" draggable={false}/>
                  </div>
                </span>
              </Link>

            <p className="max-w-xs mt-4 text-sm text-gray-300">
            ReadyforWork is an immersive career accelerator that uses Artificial Intelligence and Machine Learning to help entry-level job seekers and early-career professionals upskill and future-proof their careers with in-demand digital skills and help businesses develop diverse, less-expensive emerging talent pipeline.
            </p>
            <p className='max-w-xs mt-4 text-sm text-gray-300'>
            King Solomon{"’"}s Heights<br/>
            26, Mango Street, Accra, Ghana<br/>
            (+233) 030 280 2935<br/>
            info@sfanonline.org<br/>
            </p>
      ...
      <div className='w-full  border-t-2 border-gray-50/10'>
        <p className='text-gray-50/40 text-center py-4'>
